...
namespace Logic
{
    public class CacheFriendshipTester : IFriendshipTestInitializer
    {
        ...
        public QuestionsInitializer[] QuestionsForm
        {
            get
            {
                if (m_FriendshipTester.QuestionsForm == null)
                {
                    ...
                    {
                        m_FriendshipTester.QuestionsForm = InitializeQuestions(new FacebookUserProxy(CurrentUser));
                    }
                }
        ...
        public QuestionsInitializer[] InitializeQuestions(FacebookUserProxy i_FriendDataManager)
        {
