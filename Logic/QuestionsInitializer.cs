...
namespace Logic
{
    public class QuestionsInitializer
    {
        ...
        {
            m_Answers = new string[k_NumOfAnswersToShow];
        ...
        {
            m_Answers[m_CorrectIndex] = i_CorrectAnswer;
        }
        ...
        private void initializeRandomAnswers(int i_MinPossibleAnswer, int i_MaxPossibleAnswer)
        {
            ...
            for (int i = 0; i < k_NumOfAnswersToShow; i++)
            {
                if (i != m_CorrectIndex)
                {
                    ...
                    while (appearInArry(randomAnswer, m_Answers));

                    m_Answers[i] = randomAnswer;
                }
            }
        }
        ...
        private void initializeRandomDateTimeAnswers(DateTime i_MinDateTime, DateTime i_MaxDateTime)
        {
            ...
            for (int i = 0; i < k_NumOfAnswersToShow; i++)
            {
                if (i != m_CorrectIndex)
                {
                    ...
                    while (appearInArry(randomTime, m_Answers));

                    m_Answers[i] = randomTime;
                }
            }
        }
