...
namespace BasicFacebookFeatures
{
    public partial class FormFriendshipTestQuestion : Form
    {
        ...
        private FacebookUserProxy m_UserDataManager;
        private FacebookUserProxy m_FriendDataManager;
        private IFriendshipTestInitializer m_FriendshipTester;
        private FormFriendshipTest m_FriendshipTestForm;

        public FormFriendshipTestQuestion(User i_Friend, FormFriendshipTest i_FriendshipForm, FacebookUserProxy i_UserDateManager, IFriendshipTestInitializer i_FriendshipTester)
        {
            InitializeComponent();
        ...
        {
            m_FriendDataManager = new FacebookUserProxy(m_CurrectFriend);
            pictureBoxFriendPhoto.Invoke(new Action(() => pictureBoxFriendPhoto.LoadAsync(m_FriendDataManager.GetProfilePicture())));
            initializeQuestions();
        ...
        private void initializeCheckBoxAnswers(QuestionsInitializer i_QuestionToConvert, CheckedListBox i_CheckListToFill)
        {
            ...
            foreach (string answer in i_QuestionToConvert.m_Answers)
            {
        ...
        private void initializeScoreOnScreen()
        {
            ...
            buttonShare.Text += m_FriendDataManager.GetFirstName() + m_FriendDataManager.GetLastName();
